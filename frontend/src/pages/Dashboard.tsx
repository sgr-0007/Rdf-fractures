...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="p-8 bg-gray-100 min-h-screen">
      ...
      <footer className="bg-white shadow-md py-4 flex justify-center">
        <button className="bg-black text-white py-2 px-4 rounded shadow-md hover:bg-gray-800" onClick={goToChildDetails}>Record</button>
      </footer>
    </div>
  );
}
